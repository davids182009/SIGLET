...
define([
  ...
  function(declare,
     ...
     *
     */
    return declare("AnalisisLimites", [_WidgetBase, _TemplatedMixin,
      _WidgetsInTemplateMixin], {
      ...
      doAnalysisProcess: function() {
        ...
        if (tamano != 0) {
          ...
          // http://172.17.3.142:6080/arcgis/rest/services/FLET/Certificaciones1/GPServer/Certificaciones1/
          ...
          let params = {
            Input_JSON: featureSet
          }
          console.log(featureSet);
          geoprocessor.submitJob(params, this.exito, this.estatusProceso);

        } else {
          console.log("LA LISTA ESTA VACIA SELCCIONE...");
        }
      },
